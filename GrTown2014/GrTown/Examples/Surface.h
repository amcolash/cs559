...
const std::vector<glm::vec3> S_SKYSKRPR = {
	glm::vec3(30.0, 70.0, 0.0),
	glm::vec3(30.0, 0.0, 0.0),
	glm::vec3(0.0, 0.0, 0.0),
	glm::vec3(0.0, 70.0, 0.0),
	glm::vec3(-6.0, 90.0, 0.0),
	glm::vec3(-2.0, 90.0, 0.0),
	glm::vec3(24.0, 84.0, 0.0),
	glm::vec3(24.0, 80.0, 0.0),
	glm::vec3(-2.0, 78.0, 0.0),
	glm::vec3(-6.0, 78.0, 0.0),
	glm::vec3(-6.0, 87.0, 0.0),
	glm::vec3(-2.0, 87.0, 0.0),
	glm::vec3(26.0, 83.0, 0.0),
	glm::vec3(26.0, 80.0, 0.0),
	glm::vec3(35.0, 66.0, 0.0),
	glm::vec3(-10.0, 66.0, 0.0)
	/*
	glm::vec3(2.0, 100.0, 0.0),
	glm::vec3(0.0, 100.0, 0.0),
	glm::vec3(0.0, 99.0, 0.0),
	glm::vec3(0.0, 99.0, 0.0),
	glm::vec3(0.0, 95.0, 0.0),
	glm::vec3(-3.0, 95.0, 0.0),
	glm::vec3(0.0, 80.0, 0.0),
	glm::vec3(2.0, 80.0, 0.0),
	glm::vec3(10.0, 75.0, 0.0),
	glm::vec3(-10.0, 75.0, 0.0)*/
};